            ...
            <main className="min-h-screen bg-main ">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="relative mb-6">
                        ...
                        <div className="relative w-full h-[500px] md:h-[600px] rounded-3xl overflow-hidden shadow-lg">
                            <Image
                            ...
                            {/* About по левой стороне, по центру вертикали */}
                            <About />
                        </div>
